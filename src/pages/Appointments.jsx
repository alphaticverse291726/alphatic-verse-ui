...
export default function Appointments() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-black to-pink-900 text-white px-6 py-10">

      {/* ===== GLASS WRAPPER ===== */}
      <div className="max-w-7xl mx-auto backdrop-blur-2xl bg-white/10 border border-white/20 rounded-3xl shadow-2xl p-10">
                    ...
                    >
                      ...
                      >
                        {appt.time
                          ...
                          : `${appt.patient} (Time not assigned)`}
                      </span>
                    </label>
                  );
                })
...
function StatusCard({ icon, title, count }) {
  return (
    <div className="bg-white/5 border border-white/10 rounded-xl p-6 flex items-center gap-4 backdrop-blur">
